...
<tr class="form-field yith-choosen">
    <th scope="row" valign="top">
        <label for="key_user"><?php esc_html_e( 'Vendor Shop Owner', 'yith_wc_product_vendors' ); ?></label>
    </th>
    <td>
        <?php yit_add_select2_fields( $shop_owner_args ); ?>
        <br />
        <span class="description"><?php esc_html_e( 'User that can manage products in this shop and view sale reports.', 'yith_wc_product_vendors' ); ?></span>
    </td>
</tr>
...
<tr class="form-field">
    ...
    <td>
        <input type="text" class="regular-text" name="yith_vendor_data[paypal_email]" id="yith_vendor_paypal_email" value="<?php echo esc_html( $vendor->paypal_email ); ?>" /><br />
        <br />
...
<tr class="form-field">
    <th scope="row" valign="top">
        <label for="yith_vendor_enable_selling"><?php esc_html_e( 'Enable sales', 'yith_wc_product_vendors' ); ?></label>
    </th>
    <td>
