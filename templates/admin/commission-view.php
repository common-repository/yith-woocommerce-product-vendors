...
<div class="wrap">
	<h2>
		<?php esc_html_e( 'View Commission', 'yith-woocommerce-product-vendors' ) ?>
		<a href="<?php echo apply_filters( 'yith_wcmv_back_to_commissions_list_url', esc_url( $back_url ) ) ?>" class="add-new-h2"><?php esc_html_e( 'Back', 'yith-woocommerce-product-vendors' ) ?></a>
	</h2>
			...
			<div id="postbox-container-1" class="postbox-container">
				<div id="side-sortables" class="meta-box-sortables ui-sortable">
					...
					<form id="woocommerce-order-actions" class="postbox" method="GET">
						<h3 class="hndle ui-sortable-handle"><span><?php esc_html_e( 'Commission Actions', 'yith-woocommerce-product-vendors' ) ?></span></h3>
						<div class="inside">
							<ul class="order_actions submitbox">

								<li class="wide" id="actions">
									<select name="new_status">
										<option value=""><?php esc_html_e( 'Actions', 'yith-woocommerce-product-vendors' ) ?></option>
										<?php foreach ( YITH_Commissions()->get_status() as $status => $display ) : if ( ! YITH_Commissions()->is_status_changing_permitted( $status, $commission->status ) ) continue; ?>
											<option value="<?php echo esc_attr( $status ); ?>"><?php printf( esc_html__( 'Change to %s', 'yith-woocommerce-product-vendors' ), $display ) ?></option>
										<?php endforeach; ?>
									</select>

									<input type="hidden" name="action" value="yith_commission_table_actions" />
									<input type="hidden" name="view" value="<?php echo esc_attr( $commission->id ); ?>" />
									<button type="submit" class="button wc-reload" title="<?php esc_attr_e( 'Apply', 'yith-woocommerce-product-vendors' ) ?>"><span><?php esc_html_e( 'Apply', 'yith-woocommerce-product-vendors' ) ?></span></button>
								</li>
					...
					<div id="woocommerce-order-notes" class="postbox">
						<h3 class="hndle ui-sortable-handle"><span><?php esc_html_e( 'Commission notes', 'yith-woocommerce-product-vendors' ) ?></span></h3>
						<div class="inside">
									...
									<?php foreach ( $notes as $note ) : ?>
										<li rel="<?php echo esc_attr( $note->ID ); ?>" class="note">
											<div class="note_content">
												<p><?php echo wp_kses_post( $note->description ); ?></p>
											</div>
											<p class="meta">
												<abbr class="exact-date" title="<?php echo esc_attr( $note->note_date ); ?>"><?php printf( esc_html__( 'added on %1$s at %2$s', 'yith-woocommerce-product-vendors' ), date_i18n( wc_date_format(), strtotime( $note->note_date ) ), date_i18n( wc_time_format(), strtotime( $note->note_date ) ) ); ?></abbr>
											</p>
										</li>
									<?php endforeach; ?>
								<?php else : ?>
									<li><?php esc_html_e( 'There are no notes yet.', 'yith-woocommerce-product-vendors' ) ?></li>
								<?php endif; ?>
			...
			<div id="postbox-container-2" class="postbox-container">
				<div id="normal-sortables" class="meta-box-sortables ui-sortable">
						...
						<div class="inside">
							...
							<div class="panel-wrap woocommerce">
								<div id="order_data" class="yith-commission panel">
									<h2 class="commission-details-<?php echo esc_attr( $commission->type ); ?>">
                                        <?php $commission_title_label = 'product' == $commission->type ? esc_html_x( 'Commission', '[admin] part of commission details', 'yith-woocommerce-product-vendors' ) : esc_html_x( 'Shipping fee', '[admin] part of shipping fee details', 'yith-woocommerce-product-vendors' ); ?>
                                        <?php printf( '%s #%s %s', esc_html( $commission_title_label ), esc_html( $commission->id ), esc_html_x( 'details', '[admin] part of commission details', 'yith-woocommerce-product-vendors' ) ); ?>
                                    </h2>
                                    <p class="order_number">
										...
										printf( _x( 'credited to %s &#8212; from order %s &#8212; order status: %s', 'Commission credited to [user]', 'yith-woocommerce-product-vendors' ), wp_kses_post( $username ), wp_kses_post( $order_info ), esc_html( $order_status ) );
										?>
									</p>
									...
									<div class="order_data_column_container">
										<div class="order_data_column">
											...
											<h4><?php esc_html_e( 'General details', 'yith-woocommerce-product-vendors' ) ?></h4>
											<div class="address">
												<p>
													<strong><?php esc_html_e( 'Status', 'yith-woocommerce-product-vendors' ) ?>:</strong>
													<?php echo esc_html( $commission->get_status('display') ); ?>
												</p>
												<p>
													<strong><?php esc_html_e( 'Date', 'yith-woocommerce-product-vendors' ) ?>:</strong>
													<?php echo esc_html( $commission->get_date('display') ); ?>
												</p>
												<p>
													<strong><?php esc_html_e( 'Last update', 'yith-woocommerce-product-vendors' ) ?>:</strong>
													<?php
										...
										<div class="order_data_column">
											...
											<h4><?php esc_html_e( 'User details', 'yith-woocommerce-product-vendors' ) ?></h4>
											<div class="address">
												<p>
                                                    <?php
                                                    if( ! empty( $user ) && is_email( $user->user_email ) ) {
                                                        ...
                                                        echo '<em>' . esc_html__( 'User deleted', 'yith-woocommerce-product-vendors' ) . '</em>';
                                                    }
                                                    ?>
												</p>
												<p>
													<strong><?php esc_html_e( 'Vendor', 'yith-woocommerce-product-vendors' ) ?>:</strong>
													<?php
                                                    if( $vendor->is_valid() ) {
                                                        $vendor_url  = esc_url( get_edit_term_link( $vendor->id, $vendor->taxonomy ) );
                                                        $vendor_name = esc_html( $vendor->name );
													    echo ! empty( $vendor_url ) ? "<a href='{$vendor_url}' target='_blank'>{$vendor_name}</a>" : $vendor_name;
                                                    } else {
                                                        echo '<em>' . esc_html__( 'Vendor deleted', 'yith-woocommerce-product-vendors' ) . '</em>';
                                                    }
													?>
												</p>
												<p>
													<strong><?php esc_html_e( 'PayPal', 'yith-woocommerce-product-vendors' ) ?>:</strong>
                                                    <?php if( ! empty( $vendor->paypal_email ) && is_email( $vendor->paypal_email ) ) : ?>
                                                        <a href="mailto:<?php echo esc_attr( $vendor->paypal_email ); ?>"><?php echo esc_html( $vendor->paypal_email ); ?></a>
                                                    <?php else: ?>
                                                        <?php esc_html_e( 'Email address not set ', 'yith-woocommerce-product-vendors' ); ?>
                                                    <?php endif; ?>
												</p>
											</div>
                                        ...
                                        <?php if( ! empty( $user ) ) : ?>
                                            <div class="order_data_column">
                                                <h4><?php esc_html_e( 'Billing information', 'yith-woocommerce-product-vendors' ) ?></h4>
                                                <div class="address">
                                                    <p>
                                                        <?php
                                            ...
                                            <div class="order_data_column">
                                                <h4><?php esc_html_e( 'Shipping information', 'yith-woocommerce-product-vendors' ) ?></h4>
                                                <div class="address">
                                                    <p>
                                                        <?php
                    ...
                    <div id="woocommerce-order-items" class="postbox">
                        <h3 class="hndle ui-sortable-handle"><span><?php esc_html_e( 'Item data', 'yith-woocommerce-product-vendors' ) ?></span></h3>
                        <div class="inside">
                            ...
                            <div class="woocommerce_order_items_wrapper wc-order-items-editable">
                                <table cellpadding="0" cellspacing="0" class="woocommerce_order_items">
                                    ...
                                    <?php if ( 'product' == $commission->type ) : ?>
                                        <thead>
                                        <tr>
                                            <th class="item sortable" colspan="2"><?php esc_html_e( 'Item', 'yith-woocommerce-product-vendors' ) ?></th>
                                            <?php do_action( 'yith_wcmv_admin_order_item_headers', $order, $item, $item_id ); ?>
                                            <th class="item_cost sortable"><?php esc_html_e( 'Cost', 'yith-woocommerce-product-vendors' ) ?></th>
                                            <th class="quantity sortable"><?php esc_html_e( 'Qty', 'yith-woocommerce-product-vendors' ) ?></th>
                                            <th class="line_cost sortable" data-sort="float"><?php esc_html_e( 'Total', 'yith-woocommerce-product-vendors' ); ?></th>
                                            <?php
                                        ...
                                        <tr class="item Zero Rate" data-order_item_id="<?php echo $item_id ?>">
											...
											<td class="thumb">
												...
												<?php if ( $product ) : ?>
                                                    ...
                                                    if ( $item['variation_id'] && 'product_variation' === get_post_type( $item['variation_id'] ) ) {
                                                        echo '<br/><strong>' . esc_html__( 'Variation ID:', 'yith-woocommerce-product-vendors' ) . '</strong> ' . esc_html( absint( $item['variation_id'] ) );
                                                    } elseif ( $item['variation_id'] ) {
                                                        echo '<br/><strong>' . esc_html__( 'Variation ID:', 'yith-woocommerce-product-vendors' ) . '</strong> ' . esc_html( absint( $item['variation_id'] ) ) . ' (' . esc_html__( 'No longer exists', 'yith-woocommerce-product-vendors' ) . ')';
                                                    }

                                                    if ( $product && $product->get_sku() ) {
                                                        echo '<br/><strong>' . esc_html__( 'Product SKU:', 'yith-woocommerce-product-vendors' ).'</strong> ' . esc_html( $product->get_sku() );
                                                    }
                                            ...
                                            <td class="line_cost" width="1%" data-sort-value="<?php echo isset( $item['line_total'] ) ? esc_attr( $item['line_total'] ) : ''; ?>">
                                                <div class="view">
                                                    <?php
                                                    if ( isset( $item['line_total'] ) ) {
                                                    ...
                                                    <td class="line_tax" width="1%">
                                                        ...
                                                        <div class="edit" style="display: none;">
                                                            <div class="split-input">
                                                                <div class="input">
                                                                    <label><?php esc_html_e( 'Pre-discount:', 'yith-woocommerce-product-vendors' ); ?></label>
                                                                ...
                                                                <div class="input">
                                                                    <label><?php esc_html_e( 'Total:', 'yith-woocommerce-product-vendors' ); ?></label>
                            ...
                            <div class="wc-order-data-row wc-order-totals-items wc-order-items-editable">
                                ...
                                <table class="wc-order-totals">
                                    ...
                                    <?php if( 'product' == $commission->type ) : ?>
                                        <tr>
                                            <td class="label"><?php esc_html_e( 'Rate', 'yith-woocommerce-product-vendors' ) ?>:</td>
                                            <td class="total"><?php echo esc_html( $commission->get_rate( 'display' ) ); ?></td>
                                            <td width="1%"></td>
                                        </tr>
                                    <?php endif; ?>
                                    <tr>
                                        ...
                                        if( 'product' == $commission->type ){
                                            $commission_label = esc_html_x( 'Commission', 'Label for single commission page', 'yith-woocommerce-product-vendors' );
                                        }

                                        elseif( 'shipping' == $commission->type  ) {
	                                        $commission_label = esc_html_x( 'Shipping cost', 'Label for single commission page', 'yith-woocommerce-product-vendors' );
                                        ...
                                        <td class="label"><?php echo esc_html( $commission_label ); ?>:</td>
                                        <td class="total">
                                            <?php
                                    ...
                                    <?php if ( ! empty( (float) $commission->get_amount_refunded( 'edit' ) ) ) : ?>
                                        <tr>
                                            <td class="label refunded-total"><?php printf( '%s:', esc_html__( 'Refunded', 'yith-woocommerce-product-vendors' ) ) ?></td>
                                            <td class="total refunded-total"><?php echo wp_kses_post( $commission->get_refund_amount( 'display', $currency ) ); ?></td>
                                            <td width="1%"></td>
                                        </tr>
                                    <?php endif; ?>

                                    <tr>
                                        <td class="label"><?php printf( '%s:', esc_html__( 'Total', 'yith-woocommerce-product-vendors' ) ); ?></td>
                                        <td class="total"><?php echo wp_kses_post( $commission->get_amount_to_pay( 'display', $currency ) ); ?></td>
                                        <td width="1%"></td>
                                    </tr>
