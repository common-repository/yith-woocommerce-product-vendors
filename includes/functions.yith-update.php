<?php
$vendors_db_option = get_option( 'yith_product_vendors_db_version', false );

if( false === $vendors_db_option || $vendors_db_option === YITH_WPV_DB_VERSION ){
    return false;
}
/**
...
function yith_vendors_update_db_1_0_5() {
	...
	if ( $vendors_db_option && version_compare( $vendors_db_option, '1.0.5', '<' ) ) {
		...
		if ( defined( 'YITH_WPV_PREMIUM' ) ) {
			...
			elseif( class_exists( 'YITH_Commissions' ) && method_exists( 'YITH_Commissions', 'create_transaction_table' ) ) {
...
function yith_vendors_plugin_update_2_5_0() { ?>
	<div id="yith_wcmv_dismissable_notice" class="notice notice-error is-dismissable" style="position: relative;">
		...
		<p style="line-height: 25px;">
			...
			<br/>
			<a href='https://support.yithemes.com/hc/en-us/articles/360001424013-Multi-Vendor-Support-for-Deprecated-PayPal-Service-MassPay-and-Adaptive-Payments-' target="_blank">Multi Vendor: Support for Deprecated PayPal Service</a>
		</p>
	</div>
	<?php
}
