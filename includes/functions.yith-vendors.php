...
if( ! function_exists( 'yith_wcmv_sanitize_id' ) ){
	/**
	 * Sanitize id removing unwanted characters.
	 *
	 * E.g Users can sometimes try to track an id using not numeric characters.
	 * This function will fix this.
	 *
	 * @param int $id unsanitize id.
	 */
	function yith_wcmv_sanitize_id( $id ) {
