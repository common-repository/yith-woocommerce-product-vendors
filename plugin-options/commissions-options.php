...
return apply_filters( 'yith_wpv_panel_commissions_options', array(
	...
	'commissions' => array(
		...
		'commissions_options_title'          => array(
			'title' => esc_html__( 'General settings', 'yith-woocommerce-product-vendors' ),
			'type'  => 'title',
			'desc'  => '',
		...
		'commissions_options_base_commission' => array(
			'title'             => esc_html__( 'Commission Base', 'yith-woocommerce-product-vendors' ),
			'type'              => 'number',
			'default'           => 50,
			'desc'              => esc_html__( 'Default commission percentage', 'yith-woocommerce-product-vendors' ),
