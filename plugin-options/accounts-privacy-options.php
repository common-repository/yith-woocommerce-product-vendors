...
return apply_filters( 'yith_wpv_panel_accounts_privacy_options', array(
	...
	'accounts-privacy' => array(
		...
		'privacy_options_title'          => array(
			'title' => esc_html__( 'Personal Data Exporter', 'yith-woocommerce-product-vendors' ),
			'type'  => 'title',
		),
		...
		'privacy_eraser_options_title'          => array(
			'title' => esc_html__( 'Personal Data Eraser', 'yith-woocommerce-product-vendors' ),
			'type'  => 'title',
		),
		...
		'privacy_options_eraser_vendor_data' => array(
			...
			'desc_tip'          => sprintf( esc_html__( 'When handling an <a href="%s">account erasure request</a>, should vendor data be retained or removed?', 'yith-woocommerce-product-vendors' ), esc_url( admin_url( 'tools.php?page=remove_personal_data' ) ) ),
		...
		'privacy_options_eraser_commissions' => array(
			...
			'desc_tip'          => sprintf( esc_html__( 'When handling an <a href="%s">account erasure request</a>, should user id within commissions be retained or removed?', 'yith-woocommerce-product-vendors' ), esc_url( admin_url( 'tools.php?page=remove_personal_data' ) ) ),
